...
วัตถุที่ตรวจพบแต่จับคู่กับสินค้าที่ลงทะเบียนไว้ไม่ได้อย่างมั่นใจพอ **จะไม่แสดงกรอบใด ๆ เลย**
(ไม่ใช่กรอบ "UNKNOWN") — ตามกฎ STRICT UNKNOWN DETECTION: กรอบจะขึ้นก็ต่อเมื่อระบบมั่นใจว่าเป็น
สินค้าที่ลงทะเบียนไว้จริง ๆ เท่านั้น ถ้าจดจำสินค้านั้นไม่ค่อยแม่น ให้ไปอัปโหลดรูปเพิ่มใน AI Trainer
...
- ระบบต้องมีข้อมูลรวมกันอย่างน้อย ~4 ภาพในคลังทั้งหมด (ไม่ว่าสินค้าเดียวหรือหลายสินค้า) ก่อน
  ...
  (ไม่แสดงกรอบใด ๆ ไปก่อน ไม่ใช่กรอบ "UNKNOWN") เพื่อกันการจับคู่ผิดพลาด แล้วจะเริ่มทำงานได้เองเมื่ออัปโหลดเพิ่ม
